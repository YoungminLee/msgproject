...
import com.marker.realhotplace.PlaceInfo;
...
public class SampleData {
	...
	public SampleData(){
		...
		list.add(new LatLng(37.49450811, 126.9891121));
		...
		list.add(new LatLng(35.22546472, 129.0356741));
		list.add(new LatLng(35.23546472, 129.0352741));
